...
- [CPython v3.13.1](https://github.com/ubc-systopia/cpython/tree/microwalk-rt)
- [QuickJS 0d7aaed](https://github.com/ubc-systopia/quickjs/tree/microwalk-rt)
...
1. Clone the repository including its submodules (incl. dependencies and language runtimes)
  ...
  ```
2. Download [Intel Pin](https://www.intel.com/content/www/us/en/developer/articles/tool/pin-a-dynamic-binary-instrumentation-tool.html), extract it, and rename the folder to `pin-external`.
